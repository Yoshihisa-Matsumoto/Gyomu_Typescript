...
CREATE TABLE gyomu_status_info(
	...
	application_id smallint NOT NULL,
	entry_date bigint default floor(extract(epoch from now())*1000)  ,
...
CREATE TABLE gyomu_milestone_daily(
  ...
  update_time bigint default floor(extract(epoch from now())*1000) ,
...
CREATE TABLE gyomu_task_data_log(
	id bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	task_data_id bigint NOT NULL,
	log_time bigint default floor(extract(epoch from now())*1000)  ,
	log text NOT NULL
) ;
