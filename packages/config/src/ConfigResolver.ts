...
import { LoadedConfig } from './types/LoadedConfig.js'
import { ExcludeOption } from './types/ExcludeOption.js'
...
export interface ConfigService {
  ...
  ) => Effect.Effect<Schema.Schema.Type<ConfigSchema>, ConfigResolutionError>
}
 ...
 */
export class ConfigResolver extends Context.Service<ConfigResolver, ConfigService>()(
    ...
    return {
      get: <ConfigSchema extends EffectSchema, RawConfig extends ConfigRawConfig>(
        ...
        return Effect.gen(function* () {
          const configs: Array<LoadedConfig<RawConfig>> = []
...
/**
 * 
 * laodEnvConfig / loadStaticConfig
 ↓
mergeSources
 ↓
resolveHierarchy
