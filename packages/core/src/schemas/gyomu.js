...
import { appInfoDefinition, marketHolidayDefinition, milestoneDailyDefinition, milestoneDefinition, parameterMasterDefinition, serviceDefinition, serviceTypeDefinition, statusHandlerDefinition, statusInformationDefinition, statusTypeDefinition, taskDataDefinition, taskDataLogDefinition, taskDataStatusDefinition, taskInfoAccessListDefitniion, taskInfoDefinition, taskInstanceDefinition, taskInstanceSubmitInformationDefinition, taskSchedulerConfigDefinition, variableParameterDefinition, } from '@gyomu/shared/entity';
...
export const TaskInstanceSubmitInformationSchema = defineEntityCrudSchemas(taskInstanceSubmitInformationDefinition);
