...
describe('FtpService', () => {
  ...
  const usingLayer = Layer.provideMerge(FtpService.live, mockConfigService).pipe(
  ...
  describe('getFileInfo functionality', () => {
    it('should get file info', async () => {
      const program = Effect.gen(function* () {
        const ftp = yield* FtpService
        return yield* ftp.withConnection('', (client) => client.getFileInfo('/test/file.txt'))
      })
  ...
  describe('download functionality', () => {
    it('should download file', async () => {
      ...
      const program = Effect.gen(function* () {
        const ftp = yield* FtpService
        return yield* ftp.withConnection('', (client) => client.download(transportInfo))
      })
  ...
  describe('upload functionality', () => {
    it('should upload file', async () => {
      ...
      const program = Effect.gen(function* () {
        const ftp = yield* FtpService
        return yield* ftp.withConnection('', (client) => client.upload(transportInfo))
      })
  ...
  describe('error handling', () => {
    ...
    it('should handle config errors', async () => {
      ...
      const failureLayer = Layer.provideMerge(FtpService.live, failingConfigService).pipe(
        Layer.provide(NodeFileSystem.layer),
      )
