...
describe('fetchJson', () => {
  it('should fetch and parse json', async () => {
    ...
    const result = await Effect.runPromise(fetchJson('http://test', 'GET', null))
  ...
  it('should fail on invalid json', async () => {
    ...
    await expect(Effect.runPromise(fetchJson('http://test', 'GET', null))).rejects.toThrow()
  })
...
const createStream = (text: string) => Stream.fromIterable([new TextEncoder().encode(text)])
