...
class BusinessCalendarImpl implements BusinessCalendar {
  ...
  #market: string
  #holidays: Array<string> = new Array<string>()
  ...
  businessDay(targetDate: LocalDate, dayOffset: number): LocalDate {
    return Date2LocalDate(this.__getBusinessDay(LocalDate2Date(targetDate), dayOffset))
  }
  ...
  businessDayOfBeginningMonthWithOffset(targetDate: LocalDate, dayOffset: number = 1) {
  ...
  businessDayOfBeginningOfNextMonthWithOffset(targetDate: LocalDate, dayOffset: number = 1) {
    return Date2LocalDate(
      this.__businessDayOfBeginningOfNextMonthWithOffset(LocalDate2Date(targetDate), dayOffset),
    )
  }
  __businessDayOfBeginningOfNextMonthWithOffset(targetDate: Date, dayOffset: number = 1) {
    const businessDay = createDateOnly(
    ...
    if (this.__isBusinessDay(businessDay)) {
      if (dayOffset > 1) result = this.__getBusinessDay(businessDay, dayOffset - 1)
  ...
  businessDayOfBeginningOfPreviousMonthWithOffset(targetDate: LocalDate, dayOffset: number = 1) {
    return Date2LocalDate(
      this.__businessDayOfBeginningOfPreviousMonthWithOffset(LocalDate2Date(targetDate), dayOffset),
    )
  }
  __businessDayOfBeginningOfPreviousMonthWithOffset(targetDate: Date, dayOffset: number = 1) {
    const businessDay = createDateOnly(
  ...
  businessDayOfEndMonthWithOffset(targetDate: LocalDate, dayOffset: number) {
    return Date2LocalDate(
      this.__businessDayOfEndMonthWithOffset(LocalDate2Date(targetDate), dayOffset),
    )
  }
  ...
  businessDayOfEndOfNextMonthWithOffset(targetDate: LocalDate, dayOffset: number) {
    return Date2LocalDate(
      this.__businessDayOfEndOfNextMonthWithOffset(LocalDate2Date(targetDate), dayOffset),
    )
  }
  ...
  businessDayOfEndOfPreviousMonthWithOffset(targetDate: LocalDate, dayOffset: number) {
    return Date2LocalDate(
      this.__businessDayOfEndOfPreviousMonthWithOffset(LocalDate2Date(targetDate), dayOffset),
    )
  }
  __businessDayOfEndOfPreviousMonthWithOffset(targetDate: Date, dayOffset: number) {
    const businessDay = createDateOnly(targetDate.getFullYear(), targetDate.getMonth() + 1, 1)
    if (dayOffset === 0) dayOffset = 1
    return this.__getBusinessDay(businessDay, -dayOffset)
  }
  businessDayOfBeginningOfYear(targetDate: LocalDate, dayOffset: number) {
    return Date2LocalDate(
      this.__businessDayOfBeginningOfYear(LocalDate2Date(targetDate), dayOffset),
    )
  }
  __businessDayOfBeginningOfYear(targetDate: Date, dayOffset: number) {
    ...
    if (this.__isBusinessDay(businessDay)) return this.__getBusinessDay(businessDay, dayOffset - 1)
    return this.__getBusinessDay(businessDay, dayOffset)
  }
  businessDayOfEndOfYear(targetDate: LocalDate, dayOffset: number) {
    return Date2LocalDate(this.__businessDayOfEndOfYear(LocalDate2Date(targetDate), dayOffset))
  }
